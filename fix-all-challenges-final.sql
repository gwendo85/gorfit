-- Script final corrigé pour corriger toutes les tables challenges et user_challenges

-- 1. Créer la table challenges avec la bonne structure incluant la colonne type
...
INSERT INTO challenges (id, title, description, type, difficulty, category, icon, duration_days, target_exercises, reward_points, created_at)
VALUES 
    (gen_random_uuid(), 'Défi 30 Jours', 'Faites de l''exercice pendant 30 jours consécutifs', 'daily', 'medium', 'consistency', '🏆', 30, 30, 100, NOW()),
    (gen_random_uuid(), '100 Exercices', 'Complétez 100 exercices au total', 'total', 'hard', 'endurance', '💪', 60, 100, 200, NOW()),
    (gen_random_uuid(), 'Force Pure', 'Concentrez-vous sur les exercices de force pendant 2 semaines', 'strength', 'medium', 'strength', '🏋️', 14, 20, 150, NOW());
...
SELECT id, title, description, type, difficulty, category FROM challenges; 