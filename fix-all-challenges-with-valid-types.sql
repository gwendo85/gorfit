-- Script corrigé avec des types de challenges valides
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE challenges ADD COLUMN target INTEGER NOT NULL DEFAULT 30;
...
-- 11. Insérer des données de test dans challenges avec des types valides
...
VALUES 
    (gen_random_uuid(), 'Défi 30 Jours', 'Faites de l''exercice pendant 30 jours consécutifs', 'consistency', 30, 'medium', 'consistency', '🏆', 30, 30, 100, NOW()),
    (gen_random_uuid(), '100 Exercices', 'Complétez 100 exercices au total', 'endurance', 100, 'hard', 'endurance', '💪', 60, 100, 200, NOW()),
