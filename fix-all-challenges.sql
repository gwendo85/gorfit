-- Script complet pour corriger toutes les tables challenges et user_challenges
...
-- 11. Insérer des données de test dans challenges
...
SELECT 'Structure de la table challenges:' as info;
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_name = 'challenges' 
ORDER BY ordinal_position;

SELECT 'Structure de la table user_challenges:' as info;
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_name = 'user_challenges' 
ORDER BY ordinal_position; 